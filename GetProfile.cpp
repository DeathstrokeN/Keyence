...
int main(int argc, char**argv)
{
   ...
   char LJV_GetProfile[] = { 
                             ...
                             0xF0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x14, 
   ...
   int n;
   sleep(15*10000); //simply wait x ms for controller to answer - replace this with an event-driven approach if needed
   n=read(sockfd,recvline,10000); //read socket/received data || ,0,NULL,NULL
